...
By default, `set_testdata()` stores a reference to the provided data frame
rather than the data itself, so changes made to the data frame will be reflected
in the test results.
...
* The global test data must be reset after changes are made, either with
