...
* The `with_testdata()` block will run all `test_that()` blocks, even if some
fail. If expectations are not surrounded by a `test_that()` wrapper, the block
will exit after the first failed test.
