...
#' @param flt a logical expression to be applied as a filter for the check. This will be evaluated in the context of data
...
#' chk_filter_where(mtcars, where(~ all(. %% 1 == 0)), chk_values, TRUE, list(0:1))
#'
